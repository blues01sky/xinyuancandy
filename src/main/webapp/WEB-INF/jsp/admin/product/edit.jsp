...
<HTML>
	...
	<div class="col-lg-11">
				...
				%>
			<form action="<%=basePath %>goods/edit" method="post">
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>更新商品</STRONG>
						</strong>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="goodsname"  value="<%=goods.getCoursename() %>" id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="25%" align="center" bgColor="#f5fafe" class="ta_01">
						分类：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<select name="type">
							...
							<option value="<%=goods.getFenlei() %>">-------------</option>
							
							<%
								for(Goods goods2 : list){
							%>
							<option value="<%=goods2.getFenlei() %>"><%=goods2.getFenlei() %></option>
							<%
							}%>
						</select>
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<select name="temp5">
							<option value="<%=goods.getTemp5() %>">
							<%
							if(goods.getTemp5().equals("hot")){
								%>是<% 
							}else{
								%>否<% 
							}
							...
							<option value="<%=goods.getTemp5() %>">-------------</option>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="saleprice" id="userAction_save_do_logonName" class="bg" value="<%=goods.getSingleprice() %>"/>
						<input type="text" name="goodsid" value="<%=goods.getId() %>" hidden="hidden"/>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="jinjia" id="userAction_save_do_logonName" class="bg" value="<%=goods.getJinjia() %>"/>
					</td>
				</tr>
				<tr>
					<td width="25%" align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<input type="text" name="youhui"  id="userAction_save_do_logonName" class="bg" value="<%=goods.getYouhui() %>"/>
					</td>
				</tr>
				<tr>
					<td width="25%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="temp1" id="userAction_save_do_logonName" class="bg" value="<%=goods.getTemp1() %>"/>
					</td>
				</tr>
				<tr>
