...
<body>
	...
	<div class="col-lg-11">
		<form action="<%=basePath%>setting/addgonggao" method="post">
			<table cellSpacing="1" cellPadding="5" width="100%" align="center"
				bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26"><strong><STRONG>发布公告</STRONG> </strong></td>
				</tr>
				<tr>
					<td width="20%" align="right" bgColor="#f5fafe" class="ta_01">
						公告：</td>
					<td width="150%" align="center" bgColor="#f5fafe" class="ta_01">
						<textarea rows="10" cols="100%" style="text-align: center;" name="gonggao"></textarea>
					</td>
				</tr>
				<tr>
