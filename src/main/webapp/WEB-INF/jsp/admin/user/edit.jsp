...
<HTML>
	...
	<div class="nav col-lg-1">
		<ul class="nav nav-pills nav-stacked">
			<li role="presentation" class="active"><a href="<%=basePath%>admin/home">主页</a></li>
	...
	<div class="col-lg-11">
		<form action="<%=basePath%>user/edit" method="post">
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				%>
				<tr>
					<td width="50%" align="right" bgColor="#f5fafe" class="ta_01">
						用户名：
					</td>
					<td width="50%" align="left" bgColor="#f5fafe" class="ta_01">
						<%=user.getName() %>
					<input type="text" name="username" value="<%=user.getName() %>" hidden="hidden"/>
					<input type="text" name="userid" value="<%=user.getId() %>" hidden="hidden"/>
					</td>
				</tr>
				<tr>
					<td width="50%" align="right" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td width="50%" align="left" bgColor="#f5fafe" class="ta_01">
						<input type="text" name="consignee" value="<%=user.getConsignee() %>" />
					</td>
				</tr>
				<tr>
					<td width="50%" align="right" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
						<a href="<%=basePath %>user/reset?userid=<%=user.getId() %>"><button type="button" value="重置" >&#37325;&#32622;</button></a>
